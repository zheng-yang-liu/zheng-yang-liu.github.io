import{d as i,r as n,b as p,h as d,c as b,i as e,w as a,j as y}from"./index-QW_h9D4a.js";const x=i({__name:"basicUsage",setup(l){const t=[{name:"name",explain:"名称",type:"string"},{name:"age",explain:"年龄",type:"number",default:18},{name:"address",explain:"地址",type:[{value:"address",complexType:"'beijing' | 'shanghai' | 'sichuan' | 'hebei' | 'tianjin' | 'chengdu'"}]},{name:"hobby",explain:"爱好",type:[{value:"string"},{value:"Array",complexType:"string[]"}]}];return(r,o)=>{const s=n("xy-attribute-table");return p(),d(s,{data:t})}}}),_=`<template>\r
