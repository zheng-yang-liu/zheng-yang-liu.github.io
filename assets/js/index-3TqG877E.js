import{d as g,C as w,b as u,c as m,g as e,k as a,t as c,j as p,_ as D,D as I,r as f,i as n,w as o,E as U,l as T,G as Z,H as z,I as W,J as Q,K as $,L as _,F as N,m as A,z as G,M as ee,p as q,e as L,N as ne,O as te,n as X,P as B,o as re,v as k,Q as M,R as ae}from"./index-BBzx9Igv.js";const oe={class:"afterList"},se={class:"afterItem"},le={class:"afterItem"},ce={class:"afterItem"},ie=g({__name:"convertTimeFormat",setup(d){const t=new Date,r=t.getTime(),s={year:2021,month:1,day:1,hour:10,minute:9,second:8},l=w("YYYY-MM-DD",t),i=w("YYYY-MM-DD HH:mm:ss",r),v=w("YYYY年MM月DD日 HH时mm分s秒",s);return(x,y)=>(u(),m("div",oe,[e("div",se,[e("p",null,[a("转换前的时间格式(Date对象)："),e("code",null,c(p(t)),1)]),e("p",null,[a("转换后的的时间格式(YYYY-MM-DD)："),e("code",null,c(p(l)),1)])]),e("div",le,[e("p",null,[a("转换前的时间格式(时间戳)："),e("code",null,c(p(r)),1)]),e("p",null,[a("转换后的的时间格式(YYYY-MM-DD HH:mm:ss)："),e("code",null,c(p(i)),1)])]),e("div",ce,[e("p",null,[a("转换前的时间格式(formatDateNum时间对象)："),e("code",null,c(s))]),e("p",null,[a("转换后的的时间格式(YYYY年MM月DD日 HH时mm分s秒)："),e("code",null,c(p(v)),1)])])]))}}),de=D(ie,[["__scopeId","data-v-b539ddce"]]),pe=`<template>\r
...
</style>`,ue={class:"afterList"},me={class:"afterItem"},ve={class:"afterItem"},ye={class:"afterItem"},Y="2024.10.09",fe=g({__name:"convertDateFormatByTemplate",setup(d){const t=I(Y,"YYYY-MM-DD"),r=I(Y,"YYYY[ MM ]DD"),s=I(Y,"YYYY年MM月");return(l,i)=>(u(),m("div",ue,[e("div",me,[e("p",null,[a("转换前的时间格式："),e("code",null,c(Y))]),e("p",null,[a("转换后的的时间格式(YYYY-MM-DD)："),e("code",null,c(p(t)),1)])]),e("div",ve,[e("p",null,[a("转换前的时间格式："),e("code",null,c(Y))]),e("p",null,[a("转换后的的时间格式(YYYY[ MM ]DD)："),e("code",null,c(p(r)),1)])]),e("div",ye,[e("p",null,[a("转换前的时间格式："),e("code",null,c(Y))]),e("p",null,[a("转换后的的时间格式(YYYY年MM月)："),e("code",null,c(p(s)),1)])])]))}}),xe=D(fe,[["__scopeId","data-v-2a44ed96"]]),ge=`<template>\r
  <div class="afterList">\r
    <div class="afterItem">\r
...
</style>`,he=g({__name:"groupBy",setup(d){const t=[{name:"张三",age:18,address:"北京"},{name:"李四",age:20,address:"上海"},{name:"王五",age:17,address:"北京"},{name:"赵六",age:20,address:"上海"},{name:"孙七",age:18,address:"北京"},{name:"周八",age:20,address:"上海"},{name:"吴九",age:16,address:"北京"},{name:"郑十",age:20,address:"上海"}],r=()=>{console.log(`原始数据
`,t),console.log(`按照年龄分组
`,U(t,"age")),console.log(`年龄小于18
`,U(t,s=>s.age<18))};return(s,l)=>{const i=f("xy-button");return u(),m("div",null,[n(i,{onClick:r},{default:o(()=>[a("开始分类")]),_:1}),a(" 通过控制台查看结果 ")])}}}),be=`<template>\r
  <div>\r
...
<\/script>`,Te={class:"list"},_e={class:"item"},De={class:"item"},Fe={class:"item"},Ye=g({__name:"deepCopy",setup(d){const t=T([{name:"张三",age:18,address:"北京市朝阳区"},{name:"李四",age:20,address:"北京市海淀区"},{name:"王五",age:22,address:"北京市昌平区"}]),r=T(t.value),s=T(Z(t.value)),l=()=>{r.value[1].name="李四改变-浅拷贝",r.value[1].address="北京市海淀区改变"},i=()=>{s.value[1].name="李四改变-深拷贝",s.value[1].address="北京市海淀区改变"};return(v,x)=>{const y=f("xy-button");return u(),m("div",Te,[n(y,{onClick:l},{default:o(()=>[a("浅拷贝改变李四，地址")]),_:1}),n(y,{onClick:i},{default:o(()=>[a("深拷贝改变李四，地址")]),_:1}),e("div",_e,[a("原始值："),e("code",null,c(t.value),1)]),e("div",De,[a("浅拷贝："),e("code",null,c(r.value),1)]),e("div",Fe,[a("深拷贝："),e("code",null,c(s.value),1)])])}}}),Me=D(Ye,[["__scopeId","data-v-0fb15bb4"]]),we=`<template>\r
  <div class="list">\r
...
</style>`,Ie={style:{margin:"10px 0"}},Ce=g({__name:"accordingToKeyUnique",setup(d){const t=[{id:"1",name:"张三",age:18},{id:"2",name:"李四",age:20},{id:"1",name:"张三",age:19}],r=z(t,"id");return(s,l)=>(u(),m("div",null,[e("div",null,[e("code",null,"原始数据:"+c(t))]),e("div",Ie,[e("code",null,"去重数据:"+c(p(r)),1)])]))}}),Ne=`<template>\r
  <div>\r
...
<\/script>`,Ae={class:"item"},Re={class:"item"},Ge=g({__name:"debounce",setup(d){const t=T(0),r=T(0),s=()=>{const l=()=>{t.value++},i=()=>{console.log("lll"),r.value++},v=setInterval(l,100),x=W(i,1e3),y=setInterval(x,100);setTimeout(()=>{clearInterval(v),clearInterval(y)},3e3)};return(l,i)=>{const v=f("xy-button");return u(),m("div",null,[n(v,{onClick:s},{default:o(()=>[a("开始")]),_:1}),e("div",Ae,[a("未使用防抖："),e("code",null,c(t.value),1)]),e("div",Re,[a("使用防抖："),e("code",null,c(r.value),1)])])}}}),qe=D(Ge,[["__scopeId","data-v-ccca1220"]]),Le=`<template>\r
  <div>\r
...
<\/script>`,Be=g({__name:"fileToBase64",setup(d){const t=()=>{const r=document.createElement("input");r.type="file",r.onchange=s=>{const l=s.target.files[0];$(l,i=>{console.log(`file
`,l),console.log(i)})},r.click()};return(r,s)=>{const l=f("xy-button");return u(),m("div",null,[n(l,{onClick:t},{default:o(()=>[a("获取文件")]),_:1}),a(" 通过控制台查看结果 ")])}}}),ke=`<template>\r
  <div>\r
...
<\/script>`,je={class:"item"},Se=g({__name:"getType",setup(d){const t=[{name:"true/false",type:_(!0)},{name:"1",type:_(1)},{name:'"1"',type:_("1")},{name:"Function",type:_(()=>{})},{name:"[]",type:_([])},{name:"date",type:_(new Date)},{name:"regExp -正则",type:_(/./)},{name:"undefined",type:_(void 0)},{name:"null",type:_(null)},{name:"{}",type:_({})},{name:"blob -二进制",type:_(new Blob)},{name:"formData -表单数据",type:_(new FormData)},{name:"promise",type:_(new Promise(()=>{}))}];return(r,s)=>(u(),m("div",null,[(u(),m(N,null,A(t,l=>e("code",je,[a(c(l.name)+" 的数据类型为 ",1),e("em",null,c(l.type),1)])),64))]))}}),Ee=D(Se,[["__scopeId","data-v-e6763f19"]]),Pe=`<template>\r
  <div>\r
...
</style>`,R=[{address:"河北省",children:[{address:"石家庄市",children:[{address:"长安区"},{address:"桥西区"}]},{address:"唐山市",children:[{address:"路北区"},{address:"路南区"}]}]},{address:"山西省",children:[{address:"太原市",children:[{address:"小店区"},{address:"迎泽区"}]},{address:"大同市",children:[{address:"城区"},{address:"矿区"}]}]}],He=d=>(q("data-v-ee0943a7"),d=d(),L(),d),Je={class:"list"},Ke={class:"item"},Oe={key:0,class:"item"},Ve=He(()=>e("div",null,"转换后",-1)),Ze=g({__name:"calculateItemDepth",setup(d){const t=JSON.stringify(R,null,2),r=T(!1),s=T(""),l=()=>{const{updatedList:i,nextPos:v}=ee(R,10,0,0);s.value=JSON.stringify(i,null,2),r.value=!0};return(i,v)=>{const x=f("xy-button"),y=f("xy-code-preview");return u(),m("div",Je,[e("div",Ke,[e("div",null,[a("转换前 "),n(x,{onClick:l},{default:o(()=>[a("开始转换 ")]),_:1})]),n(y,{code:p(t),language:"JavaScript"},null,8,["code"])]),r.value?(u(),m("div",Oe,[Ve,n(y,{code:s.value,language:"JavaScript"},null,8,["code"])])):G("",!0)])}}}),ze=D(Ze,[["__scopeId","data-v-ee0943a7"]]),We=`<template>\r
  <div class="list">\r
    <div class="item">\r
      <div>转换前\r
        <xy-button\r
...
`,Qe=d=>(q("data-v-9d269ea7"),d=d(),L(),d),$e={class:"list"},en={class:"item"},nn={key:0,class:"item"},tn=Qe(()=>e("div",null,[a("搜索到的数据 "),e("em",null,[e("code",null,"条件:address===长安区")])],-1)),rn=g({__name:"deepLookup",setup(d){const t=T(!1),r=T(""),s=()=>{const l=ne(R,i=>i.address==="长安区");r.value=JSON.stringify(l,null,2),t.value=!0};return(l,i)=>{const v=f("xy-button"),x=f("xy-code-preview");return u(),m("div",$e,[e("div",en,[e("div",null,[a("原始数据 "),n(v,{onClick:s},{default:o(()=>[a("开始搜索 ")]),_:1})]),n(x,{code:"原始数据参考calculateItemDepth的原始数据",language:"JavaScript"})]),t.value?(u(),m("div",nn,[tn,n(x,{code:r.value,language:"JavaScript"},null,8,["code"])])):G("",!0)])}}}),an=D(rn,[["__scopeId","data-v-9d269ea7"]]),on=`<template>\r
  <div class="list">\r
    <div class="item">\r
      <div>原始数据\r
        <xy-button\r
...
`,sn={class:"item"},ln={class:"item"},cn=g({__name:"throttle",setup(d){const t=T(0),r=T(0),s=()=>{const l=()=>{t.value++},i=()=>{console.log("lll"),r.value++},v=setInterval(l,100),x=te(i,1e3),y=setInterval(x,100);setTimeout(()=>{clearInterval(v),clearInterval(y)},4e3)};return(l,i)=>{const v=f("xy-button");return u(),m("div",null,[n(v,{onClick:s},{default:o(()=>[a("开始")]),_:1}),e("div",sn,[a("未使用节流："),e("code",null,c(t.value),1)]),e("div",ln,[a("使用节流："),e("code",null,c(r.value),1)])])}}}),dn=D(cn,[["__scopeId","data-v-00e375be"]]),pn=`<template>\r
  <div>\r
    <xy-button @click="active">开始</xy-button>\r
...
</style>`,un={class:"list"},mn={class:"item"},vn={class:"item"},C="春风和煦,炎阳似火",yn=g({__name:"copyText",setup(d){const t=async()=>{await X(C,!1)},r=async()=>{const s=await X(C,!1);s.code===200&&B("success","自定义Msg"+s.message),s.code===100&&B("error","自定义Msg"+s.message)};return(s,l)=>{const i=f("xy-button"),v=f("xy-code-preview"),x=f("xy-input");return u(),m("div",un,[e("div",mn,[n(i,{onClick:t},{default:o(()=>[a("点击复制下面的文字")]),_:1}),n(i,{onClick:r},{default:o(()=>[a("点击复制自定义msg")]),_:1}),n(v,{code:C,style:{width:"200px",margin:"10px 0"}})]),e("div",vn,[n(x,{textarea:"",height:"150",width:"400"})])])}}}),fn=D(yn,[["__scopeId","data-v-18015c72"]]),xn=`<template>\r
  <div class="list">\r
    <div class="item">\r
...
</style>`,gn=d=>(q("data-v-96471d3e"),d=d(),L(),d),hn={class:"list"},bn={class:"item"},Tn={key:0,class:"item"},_n=gn(()=>e("div",{style:{"line-height":"32px",height:"32px"}},"转化后的颜色值",-1)),Dn=g({__name:"changeColor",setup(d){const t=[{value:"#d14e4e"},{value:"rgb(237,165,9)"},{value:"rgba(200,32,161,0.46)"},{value:"#C820A175"},{value:"rgb(15,78,149)"}],r=T([]),s=T(!1),l=()=>{s.value=!0,r.value=[],r.value.push({value:M(t[0].value,50),explain:"颜色值变浅50"}),r.value.push({value:M(t[1].value,-50),explain:"颜色值加深"}),r.value.push({value:M(t[2].value,-40),explain:"透明度减小40"}),r.value.push({value:M(t[3].value,30),explain:"透明度增大30,透明度越大颜色越深最大为1/FF,最小为0"}),r.value.push({value:M(t[4].value,30,!1),explain:"颜色值变浅30,不使用原始颜色类型值"})};return re(()=>{}),(i,v)=>{const x=f("xy-button");return u(),m("div",hn,[e("div",bn,[n(x,{onClick:l},{default:o(()=>[a("转化")]),_:1}),(u(),m(N,null,A(t,(y,F)=>e("div",{class:"originalColor",key:F},[a(" 颜色"+c(F+1)+": ",1),e("p",{style:k({backgroundColor:`${y.value}`})},null,4),a(" 颜色值: "),e("code",null,c(y.value),1)])),64))]),s.value?(u(),m("div",Tn,[_n,(u(!0),m(N,null,A(r.value,(y,F)=>(u(),m("div",{class:"originalColor",key:F},[a(" 颜色"+c(F+1)+": ",1),e("p",{style:k({backgroundColor:`${y.value}`})},null,4),a(" 颜色值: "),e("code",null,c(y.value),1),a(" 解释: "),e("code",null,c(y.explain),1)]))),128))])):G("",!0)])}}}),Fn=D(Dn,[["__scopeId","data-v-96471d3e"]]),Yn=`<template>\r
  <div class="list">\r
    <div class="item">\r
...
</style>`,Mn=g({__name:"randomInterval",setup(d){const t=T(0),r=()=>{t.value=ae(2,15)};return(s,l)=>{const i=f("xy-button");return u(),m("div",null,[n(i,{onClick:r},{default:o(()=>[a("获取2~15之间的随机整数")]),_:1}),a(" "+c(t.value),1)])}}}),wn=`<template>\r
  <div>\r
