import{d as i,r as n,o as p,c as d,b,e,w as a,u as y}from"./index-mpseKrIt.js";const x=i({__name:"basicUsage",setup(l){const t=[{name:"name",explain:"名称",type:"string"},{name:"age",explain:"年龄",type:"number",default:18},{name:"address",explain:"地址",type:[{value:"address",complexType:"'beijing' | 'shanghai' | 'sichuan' | 'hebei' | 'tianjin' | 'chengdu'"}]},{name:"hobby",explain:"爱好",type:[{value:"string"},{value:"Array",complexType:"string[]"}]}];return(r,o)=>{const s=n("xy-attribute-table");return p(),d(s,{data:t})}}}),_=`<template>\r
