import{d as g,C,b as u,c as m,g as e,k as a,t as d,j as p,_ as D,D as N,p as w,e as I,r as f,i as n,w as o,E as U,l as T,G as Z,H as z,I as W,J as Q,K as $,L as _,F as R,m as G,z as L,M as ee,N as ne,O as te,n as B,P as X,o as re,v as k,Q as Y,R as ae}from"./index-QW_h9D4a.js";const oe={class:"afterList"},se={class:"afterItem"},le={class:"afterItem"},ce={class:"afterItem"},ie=g({__name:"convertTimeFormat",setup(c){const t=new Date,r=t.getTime(),s={year:2021,month:1,day:1,hour:10,minute:9,second:8},l=C("YYYY-MM-DD",t),i=C("YYYY-MM-DD HH:mm:ss",r),v=C("YYYY年MM月DD日 HH时mm分s秒",s);return(x,y)=>(u(),m("div",oe,[e("div",se,[e("p",null,[a("转换前的时间格式(Date对象)："),e("code",null,d(p(t)),1)]),e("p",null,[a("转换后的的时间格式(YYYY-MM-DD)："),e("code",null,d(p(l)),1)])]),e("div",le,[e("p",null,[a("转换前的时间格式(时间戳)："),e("code",null,d(p(r)),1)]),e("p",null,[a("转换后的的时间格式(YYYY-MM-DD HH:mm:ss)："),e("code",null,d(p(i)),1)])]),e("div",ce,[e("p",null,[a("转换前的时间格式(formatDateNum时间对象)："),e("code",null,d(s))]),e("p",null,[a("转换后的的时间格式(YYYY年MM月DD日 HH时mm分s秒)："),e("code",null,d(p(v)),1)])])]))}}),de=D(ie,[["__scopeId","data-v-b539ddce"]]),pe=`<template>\r
