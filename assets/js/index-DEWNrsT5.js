import{d as c,a as b,r as s,o as u,b as f,e as n,w as r,f as v,u as d}from"./index-mpseKrIt.js";const _=c({__name:"basicUsage",setup(m){const t=b(!1),a=async o=>{console.log(o)};return(o,e)=>{const p=s("el-button"),l=s("xy-img-cropping");return u(),f("div",null,[n(p,{onClick:e[0]||(e[0]=i=>t.value=!0)},{default:r(()=>[v("图像裁剪")]),_:1}),n(l,{visible:t.value,"onUpdate:visible":e[1]||(e[1]=i=>t.value=i),onConfirmReturn:a},null,8,["visible"])])}}}),x=`<template>\r
  <div>\r
...
\r
</style>`,y=c({__name:"uploadNoFile",setup(m){const t=b(!1),a=async o=>{console.log(o)};return(o,e)=>{const p=s("el-button"),l=s("xy-img-cropping");return u(),f("div",null,[n(p,{onClick:e[0]||(e[0]=i=>t.value=!0)},{default:r(()=>[v("上传base64数据")]),_:1}),n(l,{title:"图像裁剪上传base64",visible:t.value,"onUpdate:visible":e[1]||(e[1]=i=>t.value=i),onConfirmReturn:a,uploadParamIsFile:!1},null,8,["visible"])])}}}),C=`<template>\r
  <div>\r
...
<style scoped lang="scss">\r
\r
</style>`,R=c({__name:"fixedCroppingSize",setup(m){const t=b(!1),a=async o=>{console.log(o)};return(o,e)=>{const p=s("el-button"),l=s("xy-img-cropping");return u(),f("div",null,[n(p,{onClick:e[0]||(e[0]=i=>t.value=!0)},{default:r(()=>[v("固定尺寸")]),_:1}),n(l,{title:"固定裁剪尺寸",visible:t.value,"onUpdate:visible":e[1]||(e[1]=i=>t.value=i),onConfirmReturn:a,previewSizeFixed:!0},null,8,["visible"])])}}}),F=`<template>\r
  <div>\r
