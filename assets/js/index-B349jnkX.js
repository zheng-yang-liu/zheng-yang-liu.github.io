import{d,h as g,b as u,e,w as n,r as t,o as m,u as f,g as x,_ as b}from"./index-mpseKrIt.js";const y=`<template>\r
  <div>\r
    <xy-showcase-page\r
...
\r
</style>`,_=d({__name:"index",setup(C){const a=g(),i=[{title:"基础用法",id:"9e06530b14cdc42bd5202949fb9a8909",slot:"basicUsage"},{title:"API",id:"6d40a10a319df3f22f5ccd965e396870",children:[{title:"Attributes",id:"8cf4ee797569ebd670ff2a027e21555a",slot:"Attributes"},{title:"Emits",id:"cbf99ccca884ce3bc38fb3bf4a0c0309",slot:"Emits"}]}],l=[{name:"catalogue",explain:"目录列表",type:[{value:"Array",complexType:`{
          id: string;
          title: string;
          slot?: string;
          explain?: string | string[];
          children?: catalogue[];
        }`}]},{name:"pageTitle",explain:"页面标题",type:"string"},{name:"introduction",explain:"页面介绍",type:[{value:"string"},{value:"Array",complexType:"string[]"}]},{name:"showCatalogue",explain:"是否显示目录",type:"boolean",default:"true"},{name:"titleTriggerRange",explain:"标题触发范围的`height`,从顶部开始计算,为屏幕高度的四分之三+`titleTriggerRange`",type:"number",default:"0"},{name:"showCatalogueWidth",explain:"动态显示目录的宽度",type:"number",default:"1075"},{name:"screenMaxCatalogue",explain:"只有全屏状态下才显示目录",type:"boolean",default:"false"},{name:"currentTitleID",explain:"当前标题ID,可以通过`getCssVar('--current-titleID')`全局获取",type:"string"}],s=[{name:"update:currentTitleID",explain:"更新当前标题ID",type:"string"}],o=()=>{a.push("/component/imageComponent/imgCropping")};return(v,h)=>{const p=t("xy-effect-preview"),r=t("xy-attribute-table"),c=t("xy-showcase-page");return m(),u("div",null,[e(c,{introduction:"对编写的组件进行说明包括基本使用样例、属性、方法等进行说明","page-title":"组件说明",catalogue:i},{basicUsage:n(()=>[e(p,{code:f(y)},{default:n(()=>[x("div",{onClick:o,class:"toPath"},"页面效果参考图像裁剪")]),_:1},8,["code"])]),Attributes:n(()=>[e(r,{data:l})]),Emits:n(()=>[e(r,{data:s,"columns-no-default":!0})]),_:1})])}}}),w=b(_,[["__scopeId","data-v-a12485f0"]]);export{w as default};
