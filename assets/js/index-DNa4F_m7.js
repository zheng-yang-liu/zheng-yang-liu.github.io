import{d as v,b as y,e as r,w as n,r as e,h as f,o as b,u as a,f as p}from"./index-DQzoCrCu.js";const w=`<template>\r
...
\r
`,G=`import {Graph} from "yanyan-ui";\r
\r
...
\r
...
}`,B=v({__name:"index",setup(X){const i=f(),u=[{title:"基础用法",id:"22d7da554d8a9cce46dcc3f2cd91751f",slot:"basicUsage"},{title:"自定义图形",id:"6f367e97d08f62052546a55ba8475d29",slot:"customizeGraphics",explain:"自定义图形,通过继承`Graph类`，编写自定义`draw`、`isInside`方法，实现绘制自定义图形，本例的椭圆为自定图形"},{title:"工具类",id:"cdc1ea8222bd9e6eef2aa5df80245f96",children:[{title:"DrawGraph",id:"a946b1bf72cdf43e0b43ec4d15105c94",slot:"DrawGraph"},{title:"Graph",id:"3a4a748c276990d2f5049cbcd81baf89",slot:"Graph",explain:"图形基类，提供基础属性和方法,快速实现自定义图形类的生成"}]},{title:"详细类型",id:"a58cda25a7165341bd4abd14aec0f325",slot:"detailType"},{title:"GraphExample",id:"c33f2dbbb280611235f89e7f044bc18d",slot:"GraphExample",explain:"通过继承`Graph类`，实现自定义椭圆图形"}],d=[{name:"constructor",explain:"构造函数 - 创建一个绘图对象。",type:[{value:"Function",complexType:`constructor(
    ...
    width:number,
    height:number,
    dpi:number)`}]},{name:"endX",explain:"设置结束点X坐标",type:[{value:"set Function",complexType:"number"}]},{name:"endY",explain:"设置结束点Y坐标",type:[{value:"set Function",complexType:"number"}]},{name:"minX",explain:"最小X坐标",type:[{value:"get Function",complexType:"number"}]},{name:"minY",explain:"最小Y坐标",type:[{value:"get Function",complexType:"number"}]},{name:"maxX",explain:"最大X坐标",type:[{value:"get Function",complexType:"number"}]},{name:"maxY",explain:"最大Y坐标",type:[{value:"get Function",complexType:"number"}]},{name:"_color",explain:"填充颜色",type:"string"},{name:"_ctx",explain:"`canvas`上下文",type:[{value:"CanvasRenderingContext2D",complexType:"CanvasRenderingContext2D"}]},{name:"_dpi",explain:"设备像素比",type:"number"},{name:"draw",explain:"绘制图形 --需继承后重写",type:[{value:"Function",complexType:"()=>void"}]},{name:"isInside",explain:"判断是否在图形内 -- 需继承后重写",type:[{value:"Function",complexType:"(x,y)=>boolean"}]}],m=()=>{i.push("/pageEffects/canvasGraphEffect")},x=()=>{i.push("/pageEffects/customizeGraphics")};return(Y,t)=>{const o=e("xy-button"),l=e("xy-effect-preview"),s=e("xy-attribute-table"),c=e("xy-code-preview"),g=e("xy-showcase-page");return b(),y("div",null,[r(g,{introduction:"可以实现各种图形的绘制，支持自定义绘制图形","page-title":"canvas绘图",catalogue:u},{basicUsage:n(()=>[r(l,{code:a(w)},{default:n(()=>[r(o,{onClick:m},{default:n(()=>t[0]||(t[0]=[p("查看效果")])),_:1})]),_:1},8,["code"])]),customizeGraphics:n(()=>[r(l,{code:a(C)},{default:n(()=>[r(o,{onClick:x},{default:n(()=>t[1]||(t[1]=[p("查看效果")])),_:1})]),_:1},8,["code"])]),DrawGraph:n(()=>[r(s,{data:d,"columns-no-default":!0})]),Graph:n(()=>[r(s,{data:h,"columns-no-default":!0})]),detailType:n(()=>[r(c,{code:a(_),language:"typescript"},null,8,["code"])]),GraphExample:n(()=>[r(c,{code:a(G),language:"typescript"},null,8,["code"])]),_:1})])}}});export{B as default};
