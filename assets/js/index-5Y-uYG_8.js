import{d as g,j as C,o as u,b as m,g as e,f as a,t as d,u as p,_ as D,k as N,p as w,i as I,r as f,e as n,w as o,l as U,a as T,m as Z,n as z,q as W,s as Q,v as $,x as _,F as R,y as G,z as B,B as ee,C as ne,D as te,E as L,G as X,H as re,I as k,J as Y,K as ae}from"./index-mpseKrIt.js";const oe={class:"afterList"},se={class:"afterItem"},le={class:"afterItem"},ce={class:"afterItem"},ie=g({__name:"convertTimeFormat",setup(c){const t=new Date,r=t.getTime(),s={year:2021,month:1,day:1,hour:10,minute:9,second:8},l=C("YYYY-MM-DD",t),i=C("YYYY-MM-DD HH:mm:ss",r),v=C("YYYY年MM月DD日 HH时mm分s秒",s);return(x,y)=>(u(),m("div",oe,[e("div",se,[e("p",null,[a("转换前的时间格式(Date对象)："),e("code",null,d(p(t)),1)]),e("p",null,[a("转换后的的时间格式(YYYY-MM-DD)："),e("code",null,d(p(l)),1)])]),e("div",le,[e("p",null,[a("转换前的时间格式(时间戳)："),e("code",null,d(p(r)),1)]),e("p",null,[a("转换后的的时间格式(YYYY-MM-DD HH:mm:ss)："),e("code",null,d(p(i)),1)])]),e("div",ce,[e("p",null,[a("转换前的时间格式(formatDateNum时间对象)："),e("code",null,d(s))]),e("p",null,[a("转换后的的时间格式(YYYY年MM月DD日 HH时mm分s秒)："),e("code",null,d(p(v)),1)])])]))}}),de=D(ie,[["__scopeId","data-v-b539ddce"]]),pe=`<template>\r
...
<\/script>`,Ge={class:"item"},qe={class:"item"},Be=g({__name:"debounce",setup(c){const t=T(0),r=T(0),s=()=>{const l=()=>{t.value++},i=()=>{console.log("lll"),r.value++},v=setInterval(l,100),x=W(i,1e3),y=setInterval(x,100);setTimeout(()=>{clearInterval(v),clearInterval(y)},3e3)};return(l,i)=>{const v=f("xy-button");return u(),m("div",null,[n(v,{onClick:s},{default:o(()=>[a("开始")]),_:1}),e("div",Ge,[a("未使用防抖："),e("code",null,d(t.value),1)]),e("div",qe,[a("使用防抖："),e("code",null,d(r.value),1)])])}}}),Ue=D(Be,[["__scopeId","data-v-ccca1220"]]),Le=`<template>\r
  <div>\r
...
</style>`,vn={class:"list"},yn={class:"item"},fn={class:"item"},A="春风和煦,炎阳似火",xn=g({__name:"copyText",setup(c){const t=async()=>{await L(A,!1)},r=async()=>{const s=await L(A,!1);s.code===200&&X("success","自定义Msg"+s.message),s.code===100&&X("error","自定义Msg"+s.message)};return(s,l)=>{const i=f("xy-button"),v=f("xy-code-preview"),x=f("xy-input");return u(),m("div",vn,[e("div",yn,[n(i,{onClick:t},{default:o(()=>[a("点击复制下面的文字")]),_:1}),n(i,{onClick:r},{default:o(()=>[a("点击复制自定义msg")]),_:1}),n(v,{code:A,style:{width:"200px",margin:"10px 0"}})]),e("div",fn,[n(x,{textarea:"",height:"150",width:"400"})])])}}}),gn=D(xn,[["__scopeId","data-v-18015c72"]]),hn=`<template>\r
  <div class="list">\r
    <div class="item">\r
